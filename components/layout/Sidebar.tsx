            ...
            <nav className="flex-1 p-4">
                <ul className="space-y-2">
                    <li>
                        <Link
                            className={
                                clsx("flex items-center text-white px-3 py-3 rounded-lg hover:bg-blue-900/20",
                                    router.pathname === "/leaderboard" ? "bg-blue-900/20": ""
                                )
                            }
                            href="/leaderboard"
                        >
                            <AiFillDashboard className="text-xl mr-2" />
                    ...
                    <li>
                        <Link
                            ...
                            href="/token"
                        >
                            <GiToken className="text-xl mr-2" />
                ...
                <div className="flex justify-center items-center min-h-screen mt-6 pt-6 border-t text-white border-gray-800">
                    <Profile
                        avatarUrl=""
                        username="CyberDeus" 
                        tokenBalance={0}
