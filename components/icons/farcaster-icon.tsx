...
export function FarcasterIcon({ className = "", size = 24 }: FarcasterIconProps) {
    return (
        <svg role="img" viewBox="0 0 24 24" className={className} width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
